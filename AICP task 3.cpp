...
void displayStudentID() {
    std::cout << "Student ID: [Noor_Fatima 2021_Bcs_035]" << std::endl<<std::endl;
    std::cout<<"\t\tElectricity_bill Data"<<std::endl<<std::endl;
    std::cout<< "\t\tslab_1 |55   65   75 |"<<std::endl;
    std::cout<< "\t\tslab_2 |120  150  170|"<<std::endl;
    std::cout<< "\t\tslab_3 |210  230  240|"<<std::endl;
}
